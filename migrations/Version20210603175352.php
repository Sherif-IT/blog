 ...
 */
final class Version20210603175352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_user_id INTEGER NOT NULL, titre VARCHAR(150) NOT NULL, date_creation DATE NOT NULL, contenu CLOB NOT NULL, date_modification DATE DEFAULT NULL)');
